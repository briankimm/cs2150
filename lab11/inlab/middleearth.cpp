//Brian Kim, byk6q, 11.30.21, middleearth.cpp
...
/**
 *@brief shuffle method 
 *@result returns nothing; shuffles vector using a specific algorithm
 */
...
/**
 *@brief a constructor for middleearth class
 *@param ints for dimenstions of the different cities; xsize, ysize, num_cities, seed
 */
...
/**
 *@brief print method
 *@return returns all the info on the created "world"
 */
// The Mouth of Sauron!
 ...
 *@return prints a tab-separated table of the distances, which can be loaded into Excel for later use.
 */
...
/**
 *@brief returns the distance between the two passes cities
 *@param first param is the first city
 *@param second param is the second city being measured
 */
...
/**
 *@brief returns the list of cities that needed to be traveled to
 *@param takes in the amount of cities you want to visit
 *@return a number of cities that you can go to
 */
